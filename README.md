...
🎓 Estudiante de **Ingeniería de Ciberseguridad** enfocado en hacking ético.  
Estoy actualmente metido en pentesting web, red teaming, aprendiendo sobre solidity (smart contracts, etc) y más.

---

### 🚀 Sobre mí y en qué estoy enfocado
- 🛡️ Aprendiendo pentesting y más en **Hack The Box**. Ademas, ultimamente estoy haciendo writeups para compartirlos aquí en github
- ⛓️ Aprendiendo **Solidity** y metiendo cada vez más en Smart Contracts.
- 🌐 Tengo un sitio web donde puse minitutoriales sobre finanzas y criptomonedas.
- 🐍 Aprendiendo más sobre **Python** y **Bash** (linux) para crear herramientas que puedan automatizar cosas.

---

### Mis páginas
🌐 **[Mi página web](https://krypto-byte.com/)**
